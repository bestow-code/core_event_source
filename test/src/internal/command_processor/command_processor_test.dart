...
main() {
  late CommandProcessor<Command, Event, State> commandProcessor;

  late CommandHandler<Command, Event, State> commandHandler;
  late StateEventHandler<Event, State> eventHandler;

  stubCommandHandler<Event>(List<EventSourcedBehaviorEffect<Event>> responses) {
