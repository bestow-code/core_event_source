...
main() {
  test('instanceFor returns EventStore by firebase appId', () {
    ...
    final eventStore1 = EventStore.instanceFor(firestore: firestore1);
    final eventStore2 = EventStore.instanceFor(firestore: firestore2);
    expect(eventStore1 == eventStore2, false);
    final firestore3 = FakeFirebaseFirestore('1');
    final eventStore3 = EventStore.instanceFor(firestore: firestore3);
